...
class TrustedDevice(models.Model):
    ...
    @classmethod
    def validity_cutoff(cls):
        return timezone.now() - timedelta(days=TRUSTED_DEVICE_VALID_DAYS)

    def is_valid(self) -> bool:
        return self.last_used_at >= self.validity_cutoff()
